...
const newEmployee = new Employee('Matt', 'Ryan', 'm@m.com', 22)
...
const newManager = new Manager('John', 'Redd', 'j@j.com', 26)
...
const progManager = new ProgressiveManager('John', 'Redd', 'j@j.com', 26)
